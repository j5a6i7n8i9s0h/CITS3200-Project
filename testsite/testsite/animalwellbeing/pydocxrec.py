...
if 'Monitoring Start Date :' in contact_details:
    if (type(contact_details['Monitoring Start Date :']) is str):
        ...
        a = str(contact_details['Monitoring Start Date :'])
        print(a)
        recording_sheet.paragraphs[0].runs[15].add_text(a)
...
recording_sheet.save('animalwellbeing/static/animalwellbeing/recordingsheets/{}_rs.docx'.format(sys.argv[2]))
